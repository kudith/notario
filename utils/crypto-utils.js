 ...
 * @returns {Promise<{publicKey: string, privateKey: string}>} A unique key pair
 */
 ...
 * @returns {Promise<{publicKey: string, privateKey: string}>} A unique ECDSA key pair
 */
